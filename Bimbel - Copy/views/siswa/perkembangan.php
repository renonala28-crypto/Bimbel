<!-- Perkembangan Page - Placeholder -->
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Perkembangan - Bimbel Portal</title>
...
<body class="dashboard-page">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="/perkembangan" class="nav-item active">Perkembangan</a>
        ...
        <main class="main-content">
            <div class="topbar">
                <div class="topbar-title"><h1>Perkembangan Saya 📈</h1></div>
            </div>

            <div class="content-area">
                <div class="card">
                    <div class="card-header">
                        <h2>Grafik Progres Pembelajaran</h2>
                    </div>
                    <p style="text-align: center; padding: 40px; color: var(--text-light);">
                        Fitur Dashboard Perkembangan sedang dalam pengembangan. Harap tunggu update berikutnya!
                    </p>
                </div>
            </div>
        </main>
